...
public class EditLinkYoutube extends AppCompatActivity implements  Response.ErrorListener, Response.Listener<JSONObject>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_link_youtube);

        rq = Volley.newRequestQueue(this);
        Bundle textoInformacion = this.getIntent().getExtras();

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Editar Link Youtube");
        setSupportActionBar(toolbar);
        getSupportActionBar().setHomeButtonEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeAsUpIndicator(android.R.drawable.ic_menu_close_clear_cancel);

        editTextInformacionEdit = (EditText) findViewById(R.id.editTextLinkYoutube);
        editTextInformacionEdit.setText( textoInformacion.getString("linkyoutube"));
        editTextInformacionEdit.setSelection(textoInformacion.getString("linkyoutube").toString().length());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.guardar_link_youtube, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.guardarlinky:
                ...
                String urlActualizacioninformacion = Constantes.IP_SERVIDOR + "gruposcochalos/actualizarinformacion/actualizarlinkyoutube.php?idgrupomusical=" + idGrupoMusical + "&linkyoutube=" + editTextInformacionEdit.getText().toString();
