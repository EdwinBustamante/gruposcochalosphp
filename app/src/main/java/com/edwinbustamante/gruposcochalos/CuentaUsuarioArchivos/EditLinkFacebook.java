...
public class EditLinkFacebook extends AppCompatActivity implements  Response.ErrorListener, Response.Listener<JSONObject>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_link_facebook);

        rq = Volley.newRequestQueue(this);
        Bundle textoInformacion = this.getIntent().getExtras();

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Editar Link Facebook");
        setSupportActionBar(toolbar);
        getSupportActionBar().setHomeButtonEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeAsUpIndicator(android.R.drawable.ic_menu_close_clear_cancel);

        editTextInformacionEdit = (EditText) findViewById(R.id.editTextLinkFaceboook);
        editTextInformacionEdit.setText( textoInformacion.getString("linkfacebook"));
        editTextInformacionEdit.setSelection(textoInformacion.getString("linkfacebook").toString().length());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.guardar_link_facebook, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.guardarlink:
                ...
                String urlActualizacioninformacion = Constantes.IP_SERVIDOR + "gruposcochalos/actualizarinformacion/actualizarlinkfacebook.php?idgrupomusical=" + idGrupoMusical + "&linkface=" + editTextInformacionEdit.getText().toString();
